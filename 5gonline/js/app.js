(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".devices-carousel__slider--products")) new swiper_core_Swiper(".devices-carousel__slider--products", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            speed: 1e3,
            lazy: true,
            navigation: {
                prevEl: ".devices-carousel__control--products-prev",
                nextEl: ".devices-carousel__control--products-next"
            },
            breakpoints: {
                320: {
                    enabled: false
        ...
        if (document.querySelector(".devices-carousel__slider--routers")) new swiper_core_Swiper(".devices-carousel__slider--routers", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            speed: 1e3,
            lazy: true,
            navigation: {
                prevEl: ".devices-carousel__control--routers-prev",
                nextEl: ".devices-carousel__control--routers-next"
            },
            breakpoints: {
                320: {
                    enabled: false
        ...
        if (document.querySelector(".devices-carousel__slider--antennas")) new swiper_core_Swiper(".devices-carousel__slider--antennas", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            speed: 1e3,
            lazy: true,
            navigation: {
                prevEl: ".devices-carousel__control--antennas-prev",
                nextEl: ".devices-carousel__control--antennas-next"
            },
            breakpoints: {
                320: {
                    enabled: false
        ...
        if (document.querySelector(".devices-carousel__slider--dongles")) new swiper_core_Swiper(".devices-carousel__slider--dongles", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            speed: 1e3,
            lazy: true,
            navigation: {
                prevEl: ".devices-carousel__control--dongles-prev",
                nextEl: ".devices-carousel__control--dongles-next"
            },
            breakpoints: {
                320: {
                    enabled: false
    ...
    function closeAllSubMenu(current = null) {
        ...
        const SubMenu = document.querySelectorAll(".menu__list ul");
    ...
    document.querySelector(".menu__list").onmouseleave = closeAllSubMenu;
    window["FLS"] = true;
    addLoadedClass();
    menuInit();
    spollers();
